        ...
        <div class="students-info-main">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-activecourses" role="tabpanel"
                    ...
                    <div class="row">
                        @forelse ($activedCourses as $course)
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                <div class="contentCard-top">
                                ...
                                <div class="contentCard-bottom">
                                    <h5>
                                        <a href="{{route('courseDetails', encryptor('encrypt', $course->id))}}" class="font-title--card">
                                            {{ $course->title }}
                                        </a>
                                    </h5>
                                    @php
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="contentCard-course--status d-flex align-items-center">
                                            <span class="percentage">{{ $randomPercentage }}%</span>
                                            <p>Finish</p>
                                        </div>
                                    </div>
                                    <a class="button button-md button--primary-outline w-100 my-3" href="{{route('courseDetails', encryptor('encrypt', $course->id))}}">
                                        Watch Course
                                    </a>
                                    <div class="contentCard-watch--progress">
                                        <span class="percentage" style="width: {{ $randomPercentage }}%;"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="nav-completedcourses" role="tabpanel"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                            <div class="contentCard contentCard--watch-course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <a href="{{route('courseDetails', encryptor('encrypt', $course->id))}}" class="button button-md button--primary-outline w-100 my-3">
                                        Watch Course
                                    </a>
                                    <div class="contentCard-watch--progress">
                        ...
                        <!-- pagination for completed course -->
                        <div class="col-lg-12 mt-lg-5">
                            <div class="pagination justify-content-center pb-0">
                                <div class="pagination-group">
                                    <a href="#" class="p_prev">
